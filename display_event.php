...
$display_query = "select event_id,event_name,event_start_date,event_end_date from calendar_event_master where event_name = 'Closed' or event_name ='Fully Booked' or event_name='Holiday-Closed'";             
